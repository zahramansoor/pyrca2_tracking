...
save('Z:\week2day_mapping_cellreg\week1\commoncells_that_are_common_across_weeks_too_fifthcolumnweekROIs.mat','week1_mapped2days_across_weeks')
...
%%
% repeat for week 2
load('C:\Users\Han\Documents\MATLAB\CellReg\ZD_week2daymap_week2_20230203\Results\cellRegistered_20230203_182420.mat')
% find cells in all sessions
[r,c] = find(cell_registered_struct.cell_to_index_map~=0);
[counts, bins] = hist(r,1:size(r,1));
...
save('Z:\week2day_mapping_cellreg\week2\commoncells_that_are_common_across_weeks_too_fifthcolumnweekROIs.mat','week2_mapped2days_across_weeks')

% repeat for week 3
load('C:\Users\Han\Documents\MATLAB\CellReg\ZD_week2daymap_week3_20230203\Results\cellRegistered_20230203_164039.mat')
% find cells in all sessions
[r,c] = find(cell_registered_struct.cell_to_index_map~=0);
[counts, bins] = hist(r,1:size(r,1));
sessions=4;% specify no of sessions
...
save('Z:\week2day_mapping_cellreg\week3\commoncells_that_are_common_across_weeks_too.mat', ...
    'week3_mapped2days_across_weeks')

% repeat for week 4
load('C:\Users\Han\Documents\MATLAB\CellReg\ZD_week2daymap_week4_20230203\Results\cellRegistered_20230203_170406.mat')
% find cells in all sessions
[r,c] = find(cell_registered_struct.cell_to_index_map~=0);
[counts, bins] = hist(r,1:size(r,1));
